...
export class News extends Component {
  ...
  const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=asfdgvdSfg&page=${this.state.page}&pageSize=${this.props.pageSize}` ;
  ...
  fetchMoreData = async () => {
    ...
    console.log(parsedData);
    this.setState({
      articles: this.state.concate(parsedData.articles),
      totalResults: parsedData.totalResults,
      loading: false
    })
  };
  ...
  render() {
    return (
      ...
      <>
        <h2 className='text-center' style={{ margin: '35px 0px' }}>NewsMonkey - Top {this.capitalise(props.category)} Headlines</h2>
